...
@Autonomous(name="Center Shoot Two Park Red", group="Park Corner")
public class VVShootTwoParkCenterRed extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        encoderTurn(12.5, 0.5, false, leftMotor, rightMotor, opModeIsActive());
