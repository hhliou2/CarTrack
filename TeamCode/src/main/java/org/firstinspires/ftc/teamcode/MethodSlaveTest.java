...
/*
        encoderForward(72, 1.0, leftMotor, rightMotor);
        encoderForward(-72, -1.0, leftMotor, rightMotor);
        encoderTurn(72, 1.0, true, leftMotor, rightMotor);
        encoderTurn(72, 1.0, false, leftMotor, rightMotor);
        lineApproach(0.25, 0.5, true, leftMotor, rightMotor, eopd);
        lineFollow(0.25, 1.0, true, leftMotor, rightMotor, touch, eopd);
