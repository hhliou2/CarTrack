...
@Autonomous(name="Corner Shoot One Cheese Red", group="cheese")
public class VVCheeseShootOneCornerRed extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        sleep(8000);
        encoderForward(49, 1.0, leftMotor, rightMotor, opModeIsActive());
